...
export default function CategoryList({ className }: { className?: string }) {
  ...
  return (
    <div id="categoryList" className={`flex flex-col gap-4 p-4 absolute top-full mt-4 left-0 z-20 bg-white shadow-1 w-64 rounded ${className}`}>
        ...
        categories.map((item: Category, idx: number) => {
          return (
            <div
              ...
              className="group relative hover:cursor-pointer inline-flex items-center w-full hover:text-primary-800 capitalize"
            >
